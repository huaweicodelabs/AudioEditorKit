...
public class MainActivity extends AppCompatActivity {
    ...
    private void startUIActivity() {
       // TODO step 3 :Launch the audio editing screen. When you tap Add audio, the SDK will automatically call the activity defined before. Then operations like editing and adding special effects can be performed on the audio. After such operations are completed, the edited audio can be exported.
    }
